  ...
  const plans = [
    {
      ...
      features: [
        ...
        "Offline Check-in Feature",
        "BM+ Organizer App",
        "Customizable Event Pages"
      ],
      addons: [
        "Tutorial Videos on How to Check-in Attendance for Crews"
      ]
    },
    {
      name: "GROWTH",
      ...
      addons: [
        "Video Tutorial on How to Book and Pay",
        "Technical Support: $30 per crew/day",
        "Telegram & Messenger Broadcasting ($50/month per 500 contacts)"
      ],
      popular: true
    },
    {
      ...
      features: [
        ...
        "Walk-in Ticket Issuing",
        "Multiple Sessions Check-in",
        "Telegram Bot Integration with Customized Post-Purchase Flow",
        "App & Website White Label"
      ]
    }
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {plans.map((plan, index) => (
          ...
          >
            ...
            {plan.subPrice && (
              <p className="text-sm text-muted-foreground mb-4">{plan.subPrice}</p>
            )}
