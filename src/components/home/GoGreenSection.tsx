...
export default function GoGreenSection() {
  ...
  const quoteRef = useScrollAnimation<HTMLDivElement>('visible', {
    threshold: 0.1
  });
  return <section className="w-full py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={featuresRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 stagger-children">
          {greenFeatures.map((feature, index) => <div key={index} className="text-center">
