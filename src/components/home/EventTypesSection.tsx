...
export default function EventTypesSection() {
  const eventTypes = [{
    icon: <img src="/lovable-uploads/a9987c12-b5b0-4ba7-82b0-dda7b2dd5b12.png" alt="Concert" className="h-10 w-10" />,
    title: "Concert",
    image: "https://github.com/MenghourLao/glass-folio-bloom/blob/main/public/lovable-uploads/concert.jpg?raw=true"
  }, {
    icon: <img src="/lovable-uploads/f97e5d93-45c8-4503-a3d1-04ad9874c842.png" alt="Sports" className="h-10 w-10" />,
    title: "Sports",
    image: "https://github.com/MenghourLao/glass-folio-bloom/blob/main/public/lovable-uploads/sport.jpg?raw=true"
  }, {
    icon: <img src="/lovable-uploads/06b52250-d4b9-4578-a3fa-4076a2c64174.png" alt="Workshop" className="h-10 w-10" />,
    ...
    icon: <img src="/lovable-uploads/493cf6b4-ad9b-486f-b4c4-11a9fc3464b2.png" alt="Arts" className="h-10 w-10" />,
    ...
    icon: <img src="/lovable-uploads/c47c180f-3b81-41e2-ae4f-9a9459e11d85.png" alt="Fundraising" className="h-10 w-10" />,
  ...
  return (
    <section className="container mx-auto py-20 px-4 bg-inherit">
      ...
      {/* Single Row - All 5 Event Types */}
      <div ref={eventsRef} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 stagger-children">
        {eventTypes.map((eventType, index) => (
          <div key={index} className="glass-card overflow-hidden rounded-3xl group hover:border-primary/50 transition-all">
            ...
            <div className="p-6 flex items-center justify-center flex-col">
              ...
              <h3 className="text-lg font-bold text-center">{eventType.title}</h3>
            </div>
          </div>
        ))}
      </div>
