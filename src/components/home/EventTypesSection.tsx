...
export default function EventTypesSection() {
  const eventTypes = [{
    icon: <img src="/about/lovable-uploads/a9987c12-b5b0-4ba7-82b0-dda7b2dd5b12.png" alt="Concert" className="h-8 w-8 sm:h-10 sm:w-10" />,
    title: "Concert",
    image: "https://github.com/MenghourLao/glass-folio-bloom/blob/main/public/lovable-uploads/concert.jpg?raw=true"
  }, {
    icon: <img src="/about/lovable-uploads/f97e5d93-45c8-4503-a3d1-04ad9874c842.png" alt="Sports" className="h-8 w-8 sm:h-10 sm:w-10" />,
    title: "Sports",
    image: "https://github.com/MenghourLao/glass-folio-bloom/blob/main/public/lovable-uploads/sport.jpg?raw=true"
  }, {
    icon: <img src="/about/lovable-uploads/06b52250-d4b9-4578-a3fa-4076a2c64174.png" alt="Workshop" className="h-8 w-8 sm:h-10 sm:w-10" />,
    ...
    icon: <img src="/about/lovable-uploads/493cf6b4-ad9b-486f-b4c4-11a9fc3464b2.png" alt="Arts" className="h-8 w-8 sm:h-10 sm:w-10" />,
    ...
    icon: <img src="/about/lovable-uploads/c47c180f-3b81-41e2-ae4f-9a9459e11d85.png" alt="Fundraising" className="h-8 w-8 sm:h-10 sm:w-10" />,
